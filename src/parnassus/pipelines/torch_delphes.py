...
from parnassus.configs.accessors import Accessor, ParticleAccessor, AccessorStore
...
from parnassus.torch_delphes.tensor_utils import (
    COLUMN_MAP as CMAP,
    PID, STATUS, CHARGE, E, PX, PY, PZ, PT, ETA, PHI,
    T, X, Y, Z, MASS, EVENT_NUMBER
)
...
def tensor_to_gen_particle_collection(
    tensor: torch.Tensor,
    name: str,
    fix_neutral_hadrons: bool = False
